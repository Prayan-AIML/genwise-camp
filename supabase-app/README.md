...
A copy of the camp app, connected to the class **Supabase** resources table and Storage bucket,
...
| `VITE_SUPABASE_STORAGE_BUCKET` | storage bucket name (`class-resources`) |
| `VITE_SUPABASE_PROJECT_REF` | Supabase project ref (`lccnubtvrjlihvyrowgq`) |
| `VITE_APP_SLUG` | this app slug for database rows and storage paths (`prayan-genwise-camp`) |
